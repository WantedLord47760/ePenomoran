            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Edit Tipe Surat</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('tipe-surat.update', $tipeSurat) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('jenis_surat') is-invalid @enderror"
                                    ...
                                    value="{{ old('jenis_surat', $tipeSurat->jenis_surat) }}" required>
                                @error('jenis_surat')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('format_penomoran') is-invalid @enderror"
                                    ...
                                    value="{{ old('format_penomoran', $tipeSurat->format_penomoran) }}" required>
                            ...
                            <div class="alert alert-info">
                                <strong>Nomor Terakhir:</strong> {{ $tipeSurat->nomor_terakhir }}
                            </div>
