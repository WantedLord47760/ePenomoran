            ...
            <div class="col-lg-10">
                <div class="card-glass">
                    ...
                    <div class="card-body p-4 pt-0">
                        <form action="{{ route('surat-masuk.update', $suratMasuk) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenis_surat') is-invalid @enderror"
                                        ...
                                        value="{{ old('jenis_surat', $suratMasuk->jenis_surat) }}" required>
                                    @error('jenis_surat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('judul_surat') is-invalid @enderror"
                                        id="judul_surat" name="judul_surat" 
                                        value="{{ old('judul_surat', $suratMasuk->judul_surat) }}" required>
                                    @error('judul_surat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('isi_surat') is-invalid @enderror"
                                    id="isi_surat" name="isi_surat" rows="4">{{ old('isi_surat', $suratMasuk->isi_surat) }}</textarea>
                                @error('isi_surat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <textarea class="form-control @error('disposisi_pimpinan') is-invalid @enderror"
                                        id="disposisi_pimpinan" name="disposisi_pimpinan" rows="2">{{ old('disposisi_pimpinan', $suratMasuk->disposisi_pimpinan) }}</textarea>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_disposisi') is-invalid @enderror"
                                        ...
                                        value="{{ old('tanggal_disposisi', $suratMasuk->tanggal_disposisi?->format('Y-m-d')) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('status_tindak_lanjut') is-invalid @enderror"
                                        ...
                                        <option value="pending" {{ old('status_tindak_lanjut', $suratMasuk->status_tindak_lanjut) === 'pending' ? 'selected' : '' }}>Pending</option>
                                        <option value="proses" {{ old('status_tindak_lanjut', $suratMasuk->status_tindak_lanjut) === 'proses' ? 'selected' : '' }}>Dalam Proses</option>
                                        <option value="selesai" {{ old('status_tindak_lanjut', $suratMasuk->status_tindak_lanjut) === 'selesai' ? 'selected' : '' }}>Selesai</option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('posisi_tindak_lanjut') is-invalid @enderror"
                                        id="posisi_tindak_lanjut" name="posisi_tindak_lanjut" 
                                        value="{{ old('posisi_tindak_lanjut', $suratMasuk->posisi_tindak_lanjut) }}">
